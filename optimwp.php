...
?>
<div class="wrap">
	<a href="<?php echo esc_url(get_bloginfo('wpurl'));?>/wp-admin/options-general.php?page=optimwp"><img src="<?php echo esc_url(plugin_dir_url( __FILE__ )) . 'images/optimwp.png'?>" width="150" alt="OptimWP Logo"></a>
...
if(is_array($my_options)) {
	...
	if(!empty($my_options['optimwp_disable_post_revisions'])){
